...
<div>
<font color="Dark">2023.11.12</font><br>
1. 新增问题：QQ双通知(#7-2-1-4)<br>
</div>
<br>
<div>
<font color="Dark">2023.10.31</font><br>
1. 全面重构指南排版
</div>
...
### <i id="7-2-6"></i>7.2.3 通知问题
#### <i id="7-2-6-1"></i>Q1：为什么我的通知长这样，为什么我的通知？？？
- A1：想优化 ***推送通知*** 请查看<u>[*`配置文件使用介绍`*](#2-1 "配置文件使用介绍")</u>】

#### <i id="7-2-6-2"></i>Q2：为什么我的QQ会有两次相同的通知
