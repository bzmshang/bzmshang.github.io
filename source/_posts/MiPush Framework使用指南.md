...
### <i id="注册成功"></i>2. 注册成功
- 在0.3.10+开始，【注册成功】这个词汇不再显示了，所以有以下2种我个人自用方法判断
...
> 1. `1_前置配置.json`
> 	- PS：使用任何`1_前置配置_xxx`都需要其配合其使用
>
> 2. `1_前置配置_清除预设通知组-黑名单.json`
> 	- PS：目前的作用是将单个应用的通知聚合成一组，本身聚合的可以不用管
